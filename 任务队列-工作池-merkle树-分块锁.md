...
```
使用 navigator.hardwareConcurrency 获取用户核心数。
如果你有 8 个核，最多用 6 个 Worker，永远留 1-2 个核给操作系统和浏览器主线程。这是“做人的基本礼貌”。
尽可能防止cpu占用100%
```

## 5.多线程案例

一秒几十次、上百次线程切换销毁，浏览器直接cpu截流了，不让js执行了。

![2026-01-24 22.24.00.png](https://s2.loli.net/2026/01/24/nXLVwJc9WkT3Y4K.png)
